...
export default function PDFPreview({ initialPdc, fullReportData, viewMode = 'ia' }: PDFPreviewProps) {
    return (
        <div id="pdc-preview" style={{ position: 'fixed', left: '-4000px', top: 0, width: '297mm', backgroundColor: '#ffffff', color: '#000000', padding: '15mm', fontFamily: 'serif', lineHeight: '1.5', fontSize: '11px', letterSpacing: '0.03em' }}>
            ...
            {initialPdc.tipo_pdc_id === 4 ? (
                <div className="force-page-break" style={{ marginBottom: '24px' }}>
                    <table style={{ width: '100%', borderCollapse: 'collapse', border: '1px solid #000000' }}>
                        <thead>
                ...
                fullReportData.areas_trabajo.map((area: FullReportArea, index: number) => (
                <div key={area.id} className="force-page-break" style={{ marginBottom: '24px', breakInside: 'avoid' }}>
                        ...
                        <tbody>
                            {(area.semanas || []).map((s: PlanificacionSemanal, idx: number) => (
                                <tr key={s.id}>
                                    ...
                                    <td style={{ border: '1px solid #000000', padding: '4px', verticalAlign: 'top', textAlign: 'justify', whiteSpace: 'pre-wrap' }}>
                                        {formatCurricularText(viewMode === 'ia' ? s.momentos_ia : s.momentos_original)}
                                    </td>
                                    ...
                                    <td style={{ border: '1px solid #000000', padding: '4px', textAlign: 'center', verticalAlign: 'middle', backgroundColor: '#f9fafb', fontSize: '9px' }}>
                            ...
                            <tr>
                                <td colSpan={6} style={{ border: '1px solid #000000', padding: '4px', whiteSpace: 'pre-wrap' }}>
