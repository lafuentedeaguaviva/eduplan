        ...
        <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-20">
            ...
            <header className="flex flex-col md:flex-row md:items-end justify-between gap-8 py-4">
                ...
                <div className="flex gap-4 flex-wrap">
                    <Link href="/dashboard/director/personal">
                        <Button className="h-14 px-6 rounded-2xl bg-white border border-slate-100 shadow-premium text-slate-900 font-black hover:bg-slate-50 gap-2 transition-all active:scale-95">
                            <span className="material-symbols-rounded text-indigo-600">group</span>
                            Personal Docente
                        </Button>
                    </Link>
                    <Link href="/dashboard/director/horarios">
                        <Button className="h-14 px-6 rounded-2xl bg-white border border-slate-100 shadow-premium text-slate-900 font-black hover:bg-slate-50 gap-2 transition-all active:scale-95">
                            <span className="material-symbols-rounded text-amber-600">calendar_month</span>
                            Horarios
                        </Button>
                    </Link>
