...
export default function PDFPreview({ initialPdc, fullReportData }: PDFPreviewProps) {
    return (
                ...
                <div key={area.id} style={{ marginBottom: '24px', breakInside: 'avoid' }}>
                    <table style={{ width: '100%', borderCollapse: 'collapse', border: '1px solid #000000', marginBottom: '16px' }}>
                        ...
                        <tbody>
                            {(area.semanas || []).map((s: PlanificacionSemanal, idx: number) => (
                                <tr key={s.id}>
                                    {idx === 0 && (
                                        <td rowSpan={area.semanas.length + 1} style={{ border: '1px solid #000000', padding: '4px', verticalAlign: 'top', textAlign: 'justify', fontStyle: 'italic' }}>
                                    ...
                                    <td style={{ border: '1px solid #000000', padding: '4px', verticalAlign: 'top', textAlign: 'justify' }}>{s.momentos_ia || "N/A"}</td>
                                    <td style={{ border: '1px solid #000000', padding: '4px', verticalAlign: 'top' }}>{s.recursos_fuentes_ia || "N/A"}</td>
                                    <td style={{ border: '1px solid #000000', padding: '4px', textAlign: 'center', verticalAlign: 'middle' }}>
                                        {area.periodos} <br/> hrs
                                    </td>
                                    {idx === 0 && (
                                        <td rowSpan={area.semanas.length + 1} style={{ border: '1px solid #000000', padding: '4px', verticalAlign: 'top', textAlign: 'justify', fontStyle: 'italic' }}>
                            ...
                            <tr>
                                <td colSpan={4} style={{ border: '1px solid #000000', padding: '4px' }}>
                    ...
                    {(area.semanas || []).some((s: PlanificacionSemanal) => s.adaptaciones_especiales_ia || s.adaptaciones_basicas_ia) && (
                        <table style={{ width: '100%', borderCollapse: 'collapse', border: '1px solid #000000', breakInside: 'avoid' }}>
                            ...
                            <tbody>
                                {area.semanas.filter((s:PlanificacionSemanal) => s.adaptaciones_especiales_ia || s.adaptaciones_basicas_ia).map((s: PlanificacionSemanal, idx: number, filteredWeeks: any[]) => (
                                    <tr key={s.id}>
                                        <td style={{ border: '1px solid #000000', padding: '4px', verticalAlign: 'top' }}>
                                            <b>Semana {s.semana}</b>
                                            {s.semana_contenido_hier?.map((root: HierarchyRoot) => (
                                        ...
                                        <td style={{ border: '1px solid #000000', padding: '4px', verticalAlign: 'top', fontStyle: 'italic' }}>{s.adaptaciones_especiales_ia || 'N/A'}</td>
                                        <td style={{ border: '1px solid #000000', padding: '4px', verticalAlign: 'top' }}>{s.adaptaciones_basicas_ia || 'N/A'}</td>
                                        {idx === 0 && (
                                            <td rowSpan={filteredWeeks.length} style={{ border: '1px solid #000000', padding: '4px', verticalAlign: 'top', color: '#374151', backgroundColor: '#f9fafb' }}>
                                                {area.criterios_evaluacion_adaptaciones}
                                            </td>
                                        )}
                                    </tr>
                                ))}
