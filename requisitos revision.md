...
export default function DirectorReviewPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    const handleReviewAction = async () => {
        ...
        try {
            ...
            await PdcRevisionesService.updateReviewStatus(id, user.id, finalStatus, observacionesPayload);
            toast.success("Revisión finalizada y enviada al profesor.");
            setIsDirty(false);
